...
namespace productos.basedatos1DataSetTableAdapters {
    ...
    public partial class clientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM \"basedatos1\".\"public\".\"clientes\" WHERE (((@IsNull_nombre = 1 AND \"nom" +
                "bre\" IS NULL) OR (\"nombre\" = @Original_nombre)) AND ((@IsNull_clave = 1 AND \"cla" +
                "ve\" IS NULL) OR (\"clave\" = @Original_clave)) AND (\"id\" = @Original_id))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""basedatos1"".""public"".""clientes"" SET ""nombre"" = @nombre, ""clave"" = @clave WHERE (((@IsNull_nombre = 1 AND ""nombre"" IS NULL) OR (""nombre"" = @Original_nombre)) AND ((@IsNull_clave = 1 AND ""clave"" IS NULL) OR (""clave"" = @Original_clave)) AND (""id"" = @Original_id))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::productos.Properties.Settings.Default.basedatos1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT \"nombre\", \"clave\", \"id\" FROM \"public\".\"clientes\"";
        ...
        public virtual int Delete(object @Original_nombre, object @Original_clave, object @Original_id) {
            ...
            if ((@Original_clave == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((object)(@Original_clave));
            }
            if ((@Original_id == null)) {
                throw new global::System.ArgumentNullException("@Original_id");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((object)(@Original_id));
            }
        ...
        public virtual int Update(object @nombre, object @clave, object @Original_nombre, object @Original_clave, object @Original_id) {
            if ((@nombre == null)) {
            ...
            if ((@clave == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((object)(@clave));
            }
            if ((@Original_nombre == null)) {
            ...
            if ((@Original_clave == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((object)(@Original_clave));
            }
            if ((@Original_id == null)) {
                throw new global::System.ArgumentNullException("@Original_id");
            }
